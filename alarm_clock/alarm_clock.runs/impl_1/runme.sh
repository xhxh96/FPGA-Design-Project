...
HD_PWD='D:/MyWork/alarm_clock/alarm_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alarm_clock.vdi -applog -m64 -messageDb vivado.pb -mode batch -source alarm_clock.tcl -notrace
