...
HD_PWD='D:/MyWork/alarm_clock/alarm_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alarm_clock.vds -m64 -mode batch -messageDb vivado.pb -notrace -source alarm_clock.tcl
